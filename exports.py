...
class SheetsExporter:
    def __init__(self, update_interval: int = 60, logger=None):
        ...
        self.logger.setLevel(logging.DEBUG)  # Временно устанавливаем уровень DEBUG
            ...
            for user in db_users:
                ...
                if sheet_row:
                    ...
                    if self.user_needs_update(user_data, sheet_row["data"]):
                        ...
                        self.logger.debug(f"User {user.userID} is up to date")
                else:
            ...
            for payment in db_payments:
                if str(payment.paymentID) not in sheet_data:
                    payment_data = [
                        ...
                        payment.firstname,
                        payment.surname,
                        payment.direction,  # Added direction field
                        payment.amount,
                        payment.method,
